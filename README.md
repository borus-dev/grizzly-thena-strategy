...
2. Sign up for [Bscscan](https://bscscan.com/) and generate an API key. This is required for fetching source codes of the mainnet contracts we will be interacting with. Store the API key in the `BSCSCAN_TOKEN` environment variable.
...
- Optional Use .env file
  ...
  2. Add the value for `BSCSCAN_TOKEN`
